...
public class AutomovilDTO {
    ...
    @Pattern(regexp = "(?i)A|B|C", message = "Modelo de automóvil no válido. Debe ser A, B o C")
    private String modelo;

    @NotNull(message = "Valor es obligatorio")
    @Positive(message = "Valor debe ser un número positivo")
    private Double valor;

    @Min(value = 0, message = "Accidentes debe ser 0 o un número positivo")
